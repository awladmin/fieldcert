...
function sample(): Eicr {
  return {
    ...
    purposeOfReport: "To ensure the installation is suitable for continued use",
    descriptionOfPremises: "domestic",
    estimatedAgeYears: 30,
    evidenceOfAlterations: false,
    installationRecordsAvailable: false,
    limitations: "Minimum of 10% removal of accessories for inspection of connections. Wiring inspected where visible",
    agreedWith: "Person ordering the report",
    generalCondition: "Installation is in a good condition and wired to current standards",
    testInstruments: { multifunction: "101067675", continuity: "101067675", insulationResistance: "101067675", earthFaultLoop: "101067675", rcd: "101067675" },
    overallAssessment: "satisfactory",
    inspector: { name: "D. Jordan", position: "Electrician", registrationNumber: "003293/000" },
